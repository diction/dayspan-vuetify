...
/**
* calender日程事件弹窗，使用el-card
*/ 

<template>
    <el-card class="ds-calendar-event-popover-card" v-bind="slotData">
        <div slot="header">
            <i class="el-icon-edit" @click="edit" v-if="!isReadOnly"></i>
            <i class="el-icon-close" @click="close"></i>
        </div>
        <div>日程主题</div>
        <div>
            <i class="fa fa-clock-o"></i><span>时间</span>
        </div>
        <div>
            <i class="el-icon-location-outline"></i><span>地点</span>
        </div>
        <div>
            <i class="fa fa-user-o"></i><span>参加人员</span>
        </div>
    </el-card>
